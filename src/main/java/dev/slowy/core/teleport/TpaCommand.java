...
@NullMarked
public final class TpaCommand implements SlowyBasicCommand {
    ...
    public void execute(CommandSourceStack stack, String[] args) {
        ...
        if (args.length < 1) {
            player.sendMessage(ColorUtils.parse("<#FFE600>Usage: /tpa <player></#FFE600>"));
            return;
        }
        ...
        teleportManager.sendRequest(player, target, TeleportType.TPA);
    }
