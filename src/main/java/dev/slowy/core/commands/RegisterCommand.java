...
@NullMarked
public final class RegisterCommand implements SlowyBasicCommand {
    ...
    public String description() {
        return "Register a new account password.";
    }
    ...
    public void execute(CommandSourceStack stack, String[] args) {
        ...
        if (args.length < 2) {
            ...
            player.sendMessage(ColorUtils.parse("<yellow>Usage: /register <password> <confirmPassword></yellow>"));
            return;
        }

        authManager.handleRegister(player, args[0], args[1]);
    }
